...
rusoldOldLatin::rusoldOldLatin(std::string input)
    : transforml(input) {
    this->type = transformType::rusoldOldLatin;
}

void rusoldOldLatin::transform() {
