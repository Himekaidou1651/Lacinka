...
bulmakLatin::bulmakLatin(std::string input)
    : transforml(input) {
    this->type = transformType::bulmakLatin;
}

void bulmakLatin::transform() {
    ...
    replaceAll(s, "\xD0\x8C", "Kj");
    replaceAll(s, "\xD0\x83", "Gj");
    replaceAll(s, "\xD0\x85", "Dz");
    ...
    replaceAll(s, "\xD1\x9C", "kj");
    replaceAll(s, "\xD1\x93", "gj");
    replaceAll(s, "\xD1\x95", "dz");

    this->output = s;
}

void bulmakLatin::outputl() {
    this->transform();
